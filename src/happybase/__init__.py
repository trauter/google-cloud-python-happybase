...
:mod:`connection <happybase.connection>`
...
the main :mod:`happybase <happybase>` package.
...
* Since there is no concept of an enabled / disabled table, calling
  :meth:`Connection.delete_table() \
      <happybase.connection.Connection.delete_table>`
  with ``disable=True`` can't be supported.
  Using that argument will result in a warning.
* The :class:`Connection <happybase.connection.Connection>`
  ...
  * ``protocol``
* In order to make
  :class:`Connection <happybase.connection.Connection>`
...
* Any uses of the ``wal`` (Write Ahead Log) argument will result in a
  ...
  * :class:`Batch <happybase.batch.Batch>`
  * :meth:`Batch.put() <happybase.batch.Batch.put>`
  * :meth:`Batch.delete() <happybase.batch.Batch.delete>`
  * :meth:`Table.put() <happybase.table.Table.put>`
  * :meth:`Table.delete() <happybase.table.Table.delete>`
  * :meth:`Table.batch() <happybase.table.Table.batch>` factory
* When calling
  :meth:`Connection.create_table() \
      <happybase.connection.Connection.create_table>`, the
...
* :meth:`Table.scan() <happybase.table.Table.scan>` no longer
...
* Using a HBase filter string in
  :meth:`Table.scan() <happybase.table.Table.scan>` is
...
* :meth:`Batch.delete() <happybase.batch.Batch.delete>` (and
  hence
  :meth:`Table.delete() <happybase.table.Table.delete>`)
...
from happybase.connection import DEFAULT_HOST
from happybase.connection import DEFAULT_PORT
